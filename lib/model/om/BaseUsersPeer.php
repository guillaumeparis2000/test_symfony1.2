...
abstract class BaseUsersPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Login', 'Password', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'login', 'password', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::LOGIN, self::PASSWORD, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'login', 'password', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Login' => 2, 'Password' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'login' => 2, 'password' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::LOGIN => 2, self::PASSWORD => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'login' => 2, 'password' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
  ...
  static public function getUniqueColumnNames()
  {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(UsersRightsPeer::RIGHT_ID, $obj->getId());
			...
			$c->add(UsersGroupsPeer::GROUPS_ID, $obj->getId());
